    ...
    <div className="about">
      <div className="about__container">
        <div className="about__left" data-aos="fade-right">
          <div className="about__title">"Bukhara Natural Product"</div>
          <div className="about__texts">
            ...
            <p className="about__text">
              "Buxoro matolari, Eco sumkalar, Bukhara fabrics, Eco
              bagsCurrently, more than 80 families contribute to the prestige
              and success of the company by providing financially for their
              families."
            </p>
            <p className="about__text">
